...
public class ParityBitAdder {
    ...
    public static String calculateParity(String bitPattern, int parityType) {
        ...
        // If parity type is 0 (even), and ones count is already even, no need to add 1, else add 1
        // If parity type is 1 (odd), and ones count is odd, no need to add 1, else add 1
